...
btncorbasepreto.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#78705e");
  document.querySelectorAll(".corbasecostas").forEach(v => v.style.fill = "#78705e");
  document.getElementById('CB').style.backgroundColor = "#78705e";
});
//base azul
